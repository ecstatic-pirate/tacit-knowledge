...
export const containers = {
  ...
  pageInner: 'w-full max-w-5xl mx-auto px-4 py-6 md:px-6 md:py-8',

  // Wider layouts (dashboards with more content) - centered with max-width
  wideContainer: 'w-full max-w-5xl mx-auto px-4 py-6 md:px-6 md:py-8',

  // Narrower layouts (forms, focused content)
  narrowContainer: 'max-w-3xl mx-auto px-4 py-6 md:px-6 md:py-8',

  // Responsive containers
  pageInnerResponsive: 'w-full max-w-5xl mx-auto px-4 py-6 md:px-6 md:py-8',
  wideContainerResponsive: 'w-full max-w-5xl mx-auto px-4 py-6 md:px-6 md:py-8',
